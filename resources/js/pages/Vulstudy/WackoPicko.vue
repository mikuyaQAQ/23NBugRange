...
const test1 = 'vulstudy/WackoPicko';
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">WackoPicko</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <div class="card collapsed-card">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    <h5 class="card-title">WackoPicko</h5>
                    <p class="card-text">
                        【漏洞】SQL注入<br>
                        【难度】low<br>
                        【解题过程】
